...
# ╚═══════════════════════════════════════════════════════════════╝
files = [
    (f"{BASE}/界限论_导论_可读重写_v0_45.md",         "导论"),
    ("_零",                                             "第零章"),  # ← 哨兵：实路径见 load_chapter()
    (f"{BASE}/界限论_第一章_可读重写_v0_32.md",         "第一章"),
    (f"{BASE}/界限论_第二章_可读重写_v0_30.md",         "第二章"),
    (f"{BASE}/界限论_第三章_可读重写_v1_15.md",         "第三章"),
    (f"{BASE}/界限论_第四章_可读重写_v0_37.md",         "第四章"),
    (f"{BASE}/界限论_第五章_可读重写_v0_24.md",          "第五章"),
    (f"{BASE}/界限论_第六章_可读重写_v0_28.md",         "第六章"),
    (f"{BASE}/界限论_第七章_可读重写_v0_47.md",         "第七章"),
    (f"{BASE}/界限论_第八章_可读重写_v0_33.md",         "第八章"),
    (f"{BASE}/界限论_第九章_可读重写_v0_30.md",         "第九章"),
