...
files = [
    ...
    (f"{BASE}/界限论_第一章_可读重写_v0_33.md",         "第一章"),
    (f"{BASE}/界限论_第二章_可读重写_v0_30.md",         "第二章"),
    (f"{BASE}/界限论_第三章_可读重写_v1_16.md",         "第三章"),
    (f"{BASE}/界限论_第四章_可读重写_v0_37.md",         "第四章"),
    (f"{BASE}/界限论_第五章_可读重写_v0_25.md",          "第五章"),
    (f"{BASE}/界限论_第六章_可读重写_v0_28.md",         "第六章"),
    (f"{BASE}/界限论_第七章_可读重写_v0_48.md",         "第七章"),
    (f"{BASE}/界限论_第八章_可读重写_v0_37.md",         "第八章"),
    (f"{BASE}/界限论_第九章_可读重写_v0_30.md",         "第九章"),
    (f"{BASE}/界限论_尾声_可读重写_v0_34.md",           "尾声"),
    (f"{BASE}/界限论_附录W_v8_44.md",                   "附录"),
]
