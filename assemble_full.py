...
# ╚═══════════════════════════════════════════════════════════════╝
files = [
    (f"{BASE}/界限论_导论_可读重写_v0_40.md",         "导论"),
    ("_零",                                             "第零章"),  # ← 哨兵：实路径见 load_chapter()
    (f"{BASE}/界限论_第一章_可读重写_v0_25.md",         "第一章"),
    (f"{BASE}/界限论_第二章_可读重写_v0_24.md",         "第二章"),
    (f"{BASE}/界限论_第三章_可读重写_v1_8.md",          "第三章"),
    (f"{BASE}/界限论_第四章_可读重写_v0_30.md",         "第四章"),
    (f"{BASE}/界限论_第五章_可读重写_v0_16.md",          "第五章"),
    (f"{BASE}/界限论_第六章_可读重写_v0_24.md",         "第六章"),
    (f"{BASE}/界限论_第七章_可读重写_v0_32.md",         "第七章"),
    (f"{BASE}/界限论_第八章_可读重写_v0_25.md",         "第八章"),
    (f"{BASE}/界限论_第九章_可读重写_v0_15.md",         "第九章"),
    (f"{BASE}/界限论_尾声_可读重写_v0_14.md",           "尾声"),
    (f"{BASE}/界限论_附录W_v8_8.md",                    "附录"),
]
...
function showFnBubble(a, fid) {{
  ...
  if (left < 8) left = 8;
  if (rect.bottom + bRect.height > window.innerHeight - 12) {{
    top = rect.top + window.scrollY - bRect.height - 8;
...
def load_chapter(file_path, ch_name):
    ...
    if file_path == "_零":
        actual = f"{BASE}/界限论_第零章_可读重写_v0_38.md"
    else:
        actual = file_path
...
DPIAGRAM_REPLACE = [
    ...
    ('   窗口半 W.2.6(客观世界存否不可内生判定)',
     '   窗口半 <a href="#w-2" class="d-link">W.2.6</a>(客观世界存否不可内生判定)'),
    ('   舞台半 W.2.7(环境欠定,命题 R★)',
