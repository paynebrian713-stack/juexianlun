...
# ╚═══════════════════════════════════════════════════════════════╝
files = [
    (f"{BASE}/界限论_导论_可读重写_v0_34.md",         "导论"),
    ("_零",                                             "第零章"),  # ← 哨兵：实路径见 load_chapter()
    (f"{BASE}/界限论_第一章_可读重写_v0_21.md",         "第一章"),
    (f"{BASE}/界限论_第二章_可读重写_v0_21.md",         "第二章"),
    (f"{BASE}/界限论_第三章_可读重写_v1_5.md",          "第三章"),
    (f"{BASE}/界限论_第四章_可读重写_v0_25.md",         "第四章"),
    (f"{BASE}/界限论_第五章_可读重写_v0_14.md",          "第五章"),
