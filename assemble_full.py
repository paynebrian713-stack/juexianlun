...
# ╚═══════════════════════════════════════════════════════════════╝
files = [
    (f"{BASE}/界限论_导论_可读重写_v0_44.md",         "导论"),
    ("_零",                                             "第零章"),  # ← 哨兵：实路径见 load_chapter()
    (f"{BASE}/界限论_第一章_可读重写_v0_31.md",         "第一章"),
    (f"{BASE}/界限论_第二章_可读重写_v0_30.md",         "第二章"),
    (f"{BASE}/界限论_第三章_可读重写_v1_12.md",         "第三章"),
    (f"{BASE}/界限论_第四章_可读重写_v0_36.md",         "第四章"),
    (f"{BASE}/界限论_第五章_可读重写_v0_21.md",          "第五章"),
    (f"{BASE}/界限论_第六章_可读重写_v0_26.md",         "第六章"),
    (f"{BASE}/界限论_第七章_可读重写_v0_46.md",         "第七章"),
    (f"{BASE}/界限论_第八章_可读重写_v0_32.md",         "第八章"),
    (f"{BASE}/界限论_第九章_可读重写_v0_25.md",         "第九章"),
    (f"{BASE}/界限论_尾声_可读重写_v0_34.md",           "尾声"),
    (f"{BASE}/界限论_附录W_v8_41.md",                   "附录"),
]
...
<div id="map-overlay">
 <div class="map-container">
  ...
  <div class="map-svg-wrap"><object id="map-svg" data="reality-map.svg?v=11" type="image/svg+xml"></object></div>
 </div>
</div>
...
def strip_footnotes_and_refs(text, ch_name=""):
    """生成无脚注稿。附录削减防御层/元评论/W.0导言/W.6讨论/W.7开放，只留定理本体。"""
